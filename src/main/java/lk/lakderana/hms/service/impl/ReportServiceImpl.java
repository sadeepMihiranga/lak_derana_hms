...
public class ReportServiceImpl implements ReportService {
    ...
    @Override
    public JasperPrint generateInquiryReport(String startDate, String endDate, String reportType) throws IOException, JRException, ParseException {
        ...
        log.info("generate Pending Major Errors Report, startDate:{}, endDate:{}", startDate, endDate);
        return print;
